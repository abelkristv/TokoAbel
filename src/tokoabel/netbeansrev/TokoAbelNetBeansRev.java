 ...
 * @author jedith
 */
public class TokoAbelNetBeansRev extends javax.swing.JFrame {

    public TokoAbelNetBeansRev() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TokoAbelNetBeansRev.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new TokoAbelNetBeansRev().setVisible(true);
        });
    }
